...
while survival_points > 0:
    ...
    if user_input == "1": #pepper
        ...
        if user_input7_2 == "0":
            user_input7 = input("How much do you add? / a pinch / a teaspoon / a tablespoon / THE PEPPER SHAKER SPECIAL \n 0/1/2/3?: ")
            if user_input7 == "0":
                survival_points -= 1
                print(f"Good job! You increased your chances of survival. You currently have {survival_points} survival points.")
            elif user_input7 == "1" or user_input7 =="2":
                ...
                print("As you shake every last bit of pepper that you have left, you look over to the mom's face filled with anger and in the moment, she instantly takes a hold of you and smashes you against the ground. As you are falling to your doom, you think to yourself 'Was this really the right choice?'")
                survival_points -= 10000
        ...
        if survival_points <= 0:
            print("Your survival points went below 1. You lost. Your current location is now the dumpster. :(")
            break
    print(f"Conngratulations, you have made it through one week at the kitchen. You are free to shake anywhere you want, nobody is trying to put you in the garbage. You are finally a free {user_name}. ")
    break